...
- [examples/hospital-cpm-playbook-session.html](https://dr3d.github.io/prolog-reasoning/examples/hospital-cpm-playbook-session.html)
- [examples/fantasy-overlord-session.html](https://dr3d.github.io/prolog-reasoning/examples/fantasy-overlord-session.html)
- [Live pages root](https://dr3d.github.io/prolog-reasoning/examples/)
